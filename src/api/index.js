...
// 创建订单
export const orderCreate = function (goodsInfo, note, deduce) {
  return http.post(mall + '/order/create', {goodsInfo: goodsInfo, note: note, deduce}, true)
}
// 订单记录
...
// 商家申请提交信息
export const applyConfirm = function (type, title, cid, model, username, mobile, province, city, district, address, logo) {
  return http.post(mall + '/users/shops-applyfor', {type, title, cid, model, username, mobile, province, city, district, address, logo}, true)
}
// 个人中心信息返回
...
// 线下商城--付款订单
export const underPayInfo = function (type, spid, price, deduce) {
  return http.post(mall + '/oto/pay', {type: type, spid: spid, price: price, deduce}, true)
}
// 线下商城-- 支付
...
// 线下商城-- 商品下单
export const underShopGoodBuy = function (model, goodsInfo, note, deduce) {
  return http.post(mall + '/order/create', {model: model, goodsInfo: goodsInfo, note: note, deduce}, true)
}
// 线下商城-- 商品订单
