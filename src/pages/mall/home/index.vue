<template>
  <div id="home" class="homeMall">
    ...
    <div class="seach_main"  :style="{paddingTop: (statusH + 0.2) + 'rem',background: headBoxH > statusH ? 'linear-gradient('+$store.state.global.mallSearch.bgDeg+'deg,' +$store.state.global.mallSearch.bgColor+','+$store.state.global.mallSearch.bgSecondColor+')' : '#fff'}">
      ...
      <div class="linchpin" :key="item.id" v-if="item.name === 'edit-mall-hot-search'" :style="{background: 'linear-gradient('+$store.state.global.mallHot.bgDeg+'deg,' +$store.state.global.mallHot.bgColor+','+$store.state.global.mallHot.bgSecondColor+')'}">
