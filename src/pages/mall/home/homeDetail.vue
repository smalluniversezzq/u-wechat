      ...
      <div class="detail_main" id="detail_main" ref="my_scroller">
        <div class="banner" style="position:relative">
          ...
          <div class="title">
            ...
            <div class="price_main"><span>¥ </span>{{detailObj.spe_price}} <del style="font-size: 0.25rem; font-weight: normal; color: #ccc; margin-left: 0.2rem">¥{{detailObj.marketprice}}</del></div>
            <div class="bottom">
            ...
            <div class="header">
              <div class="header_main">
                ...
                <div class="right_main">
                  ...
                  <div class="div3" v-if="detailObj.field1 || detailObj.field2">选择{{detailObj.field1}} {{detailObj.field2}}</div>
                </div>
              </div>
            </div>
