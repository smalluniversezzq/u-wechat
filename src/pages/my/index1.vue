<template>
  <div id="my" class="tbkMy">
    <mescroll-vue ref="mescroll"  :down="mescrollDown"  @init="mescrollInit">
      <div class="head" style="background: #ffffff;height: 4.38rem;">
        <!--<img src="../../assets/img/my/my_head.png" alt="" class="bg">-->
        <!--<div class="t">我的</div>-->
        <img style="top: 0.64rem;" src="../../assets/img/super/shezhi.png" alt="" class="setting" @click="jumpTo('/info')">
        <div class="box" style="top: 1.28rem;">
          ...
          <!--<img :src="data.avatar" alt="" @click="jumpTo('/info')" v-if = "data && data.avatar">-->
          <!--<img src="../../assets/img/my/avater.png" alt="" @click="jumpTo('/info')" v-else>-->
          <div class="info" v-if="$store.state.user.token">
            <div class="tou">
              ...
              <!--</div>-->
              <p class="name" style="color: #333333">{{data.nickname}} </p><span v-if="data.lv"><img src="../../assets/img/my/lvIcon.png" alt="">{{data.lv}}</span>
            </div>
            <!--<p class="uid">ID：{{data.uid}}</p>-->
            <p class="invite"  @click="onCopy(data.invite_code)" v-if="data.invite_code"><span style="color: #666666">邀请码：</span><span style="color: #666666">{{data.invite_code}}</span><span class="copyObj" style="color: #fc3357;background: #FFE7EE">复制</span></p>
          </div>
      ...
      <div class="moneysBox">
        ...
        <div class="top" @click="jumpTo('/pullNew')" v-if="$bizId === 6 || $bizId === 4">
          <img src="../../assets/img/auth/yqhy.png" alt="">
        </div>
        <div class="top" @click="jumpTo('/invite')">
