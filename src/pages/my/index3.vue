<template>
  <div id="my" class="tbkMy">
    ...
    <div class="moneysBox">
      <img src="../../assets/img/my/setting.png" :style="{top: 0.3 + 'rem'}" alt="" class="setting" @click="jumpTo('/info')">
      <div class="headBox" :style="{marginTop: 1 + 'rem'}">
        <div class="top">
          <div class="avater" v-if="data && data.avatar" @click="jumpTo('/info')" :style="{backgroundImage: 'url(' + data.avatar + ')'}">
            <div class="lv"><img src="../../assets/img/my/lv.png" alt=""><span>{{data.lv}}</span></div>
          </div>
          <div class="avater" v-else @click="jumpTo('/info')">
            <div class="lv" v-if="data"><img src="../../assets/img/my/lv.png" alt=""><span>{{data.lv}}</span></div>
          </div>
