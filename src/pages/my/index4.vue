    ...
    <div class="moneysBox">
      ...
      <div class="headBox" :style="{marginTop: settingH + 1 + 'rem'}">
        <div class="top">
          ...
          <div class="profitBox">
            <div class="profit" @click="jumpTo('/coupon?title='+ data.couponpass_name)" v-if="$isCouponPass === '1'">
              <p v-if="data && data.couponpass_money">￥{{data.couponpass_money}}</p>
              <p v-else> 0.00</p>
              <p v-if="data && data.couponpass_name">{{data.couponpass_name}}</p>
              <p v-else>优惠券余额</p>
            </div>
