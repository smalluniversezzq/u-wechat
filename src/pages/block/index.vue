    ...
    <div class="index">
      ...
      <div class="box">
        <div class="myBox">
          ...
          <div class="change"><span>我的{{data.credit_alias ? data.credit_alias : '集分宝'}}{{data.credit4}}个</span><span @click="jumpTo('/exchange')" :style="{color: $store.state.global.theme.mainColor}">兑换区块币</span></div>
        </div>
        <div class="today">
          <div>
