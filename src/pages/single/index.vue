        ...
        <div class="single_body">
          <div class="single_list" v-for="(item,i) in list" :key="i">
            ...
            <div class="single_item">
              ...
              <p class="single_item_two">￥<span>{{(item.price-item.free_money).toFixed(2)}}</span><span>￥{{item.price}}</span></p>
    ...
    upCallback (page, mescroll) {
      this.$http.post('/amoy/home/free-order', {page: page.num}).then(res => {
        if (res.code === 0) {
          ...
          let arr = res.data === '' || res.data.data === '' ? [] : res.data.data
